  ...
  return (
    <section className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white px-4 py-8 transition-all duration-500 ease-in-out relative overflow-hidden min-h-screen">
      ...
      <div className="relative z-10 mt-12 flex justify-center">
        <button className="px-6 py-3 bg-orange-500 hover:bg-orange-600 transition-all text-white font-semibold text-lg rounded-full shadow-md hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-300 cursor-pointer">
          Get Started
        </button>
      </div>
    </section>
