  ...
  return (
    <section className="bg-slate-800">
      <div className="max-w-6xl mx-auto text-white p-8  space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {chaiOptions.slice(0, 5).map((option, optionIndex) => {
              return (
                <button
                  key={optionIndex}
                  className="p-3 rounded-lg bg-gray-700 border-gray-600 text-left cursor-pointer flex flex-col justify-center items-center gap-2 transition-all duration-200 hover:scale-105 hover:border-orange-400 border-2"
                >
            ...
            <button className="p-3 rounded-lg bg-gray-700 border-gray-600 text-left cursor-pointer flex flex-col justify-center items-center gap-2 transition-all duration-200 hover:scale-105 hover:border-white border-2">
              <h5 className="font-medium text-lg">Others</h5>
              <p className="text-sm text-gray-300">N/A</p>
            </button>
          </div>

          <select className="mt-3 w-full bg-gray-700 text-white border border-gray-600 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-orange-400 appearance-none">
        ...
        {/* Submit Button */}
        <button className="w-full h-12 text-xl cursor-pointer bg-orange-500 hover:bg-orange-600 transition text-white font-semibold py-2 rounded-full shadow">
          Add Entry
        </button>
      </div>
    </section>
